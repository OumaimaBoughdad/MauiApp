...
namespace RestaurantPOS.ViewModels
{
    public partial class OrdersViewModel : ObservableObject
    {
        ...
        private void OnHomeButtonClicked(object sender, EventArgs e)
        {
            ...
            // Or however you navigate in your app
        }


        private void OnOrdersButtonClicked(object sender, EventArgs e)
        {
            // This is the current page, so you might not need to do anything
            // Or you could refresh the data
        }

        private void OnFoodButtonClicked(object sender, EventArgs e)
        {
            // Navigate to the food page
            Shell.Current.GoToAsync("//FoodPage");
            // Or however you navigate in your app
        }
