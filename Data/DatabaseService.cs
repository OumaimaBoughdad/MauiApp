...
namespace RestaurantPOS.Data
{
    public class DatabaseService : IAsyncDisposable
    {
        ...
        public DatabaseService()
        {
            ...
            var dbPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + @"\f4.db3");
            Console.WriteLine($"Database path is right here : {dbPath}");
            // or use Debug.WriteLine, or any logging framework you're using
